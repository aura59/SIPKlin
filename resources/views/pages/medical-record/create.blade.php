...
<h1 class="h6 text-gray-800 mb-4">Pelayanan / Rekam Medis</h1>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const patientInformation = document.getElementById('patient-information');
    ...
    registrationSelect.addEventListener('change', function () {
        ...
        document.getElementById('patient-nama').textContent = selectedOption.dataset.nama || '-';

        document.getElementById('patient-nik').textContent = selectedOption.dataset.nik || '-';

        document.getElementById('patient-jenis-kelamin').textContent = selectedOption.dataset.jenisKelamin || '-';

        document.getElementById('patient-tanggal-lahir').textContent = formatDate(selectedOption.dataset.tanggalLahir);

        document.getElementById('patient-poli').textContent = selectedOption.dataset.poli || '-';

        document.getElementById('patient-dokter').textContent = selectedOption.dataset.dokter || '-';
    });
